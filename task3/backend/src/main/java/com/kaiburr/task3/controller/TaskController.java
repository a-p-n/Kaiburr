package com.kaiburr.task3.controller;

import com.kaiburr.task3.model.Task;
import com.kaiburr.task3.model.TaskExecution;
import com.kaiburr.task3.repository.TaskRepository;
...
public class TaskController {
    ...
    private boolean isUnsafe(String command) {
        ...
        String[] maliciousCommands = { "rm", "sudo", ";", "&&", "||", "`", "$(", "root" };
